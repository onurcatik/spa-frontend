      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 hover:rotate-2 hover:bg-gray-50 dark:hover:bg-gray-700">
            <img src="https://placehold.co/600x400" alt="Check-up Hizmetleri" className="w-full h-48 object-cover rounded-lg mb-4" />
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 hover:rotate-2 hover:bg-gray-50 dark:hover:bg-gray-700">
            <img src="https://placehold.co/600x400" alt="Tedavi ve Danışmanlık" className="w-full h-48 object-cover rounded-lg mb-4" />
          ...
          {/* Ameliyat Hizmetleri */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 hover:rotate-2 hover:bg-gray-50 dark:hover:bg-gray-700">
            <img src="https://placehold.co/600x400" alt="Ameliyat Hizmetleri" className="w-full h-48 object-cover rounded-lg mb-4" />
