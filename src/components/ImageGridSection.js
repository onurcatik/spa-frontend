      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white p-4 rounded-lg shadow-md dark:bg-gray-700 flex items-center">
            <img src="https://placehold.co/600x400" alt="Başarı Projesi 1" className="rounded-lg w-1/2" />
          ...
          <div className="bg-white p-4 rounded-lg shadow-md dark:bg-gray-700 flex items-center">
            <img src="https://placehold.co/600x400" alt="Başarı Projesi 2" className="rounded-lg w-1/2" />
            <div className="ml-4 text-left">
